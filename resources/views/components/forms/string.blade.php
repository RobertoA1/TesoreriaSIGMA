<div>
    ...
    <input @if(isset($placeholder)) placeholder="{{ $placeholder }}" @endif @if(isset($value)) value="{{ $value }}" @endif type="text" name="{{isset($name) ? Str::snake($name) : Str::snake($label)}}" @if(isset($readonly) && $readonly) readonly @endif
