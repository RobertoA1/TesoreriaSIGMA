...
@section('contenido')
    <div class="p-8 m-4 bg-gray-100 dark:bg-white/[0.03] rounded-2xl">
        ...
        <form method="POST" id="form" action="" class="mt-8">
            ...
            <div class="mb-8">
                <x-ui.section-title :iconColor="'text-red-500'">
                    <x-slot name="iconPath">
            ...
            <div class="mb-8">
                <x-ui.section-title :iconColor="'text-yellow-500'">
                    <x-slot name="iconPath">
            ...
            <div class="mb-8">
                <x-ui.section-title :iconColor="'text-indigo-500'">
                    <x-slot name="iconPath">
            ...
            <div class="mb-8">
                <x-ui.section-title :iconColor="'text-teal-500'">
                    <x-slot name="iconPath">
